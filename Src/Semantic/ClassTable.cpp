...
namespace CoolCompiler {
    ...
    ClassTable::ClassTable(Program *program) : ClassTable() {
        this->program = program;
    }

    bool ClassTable::resolveDefinedClasses() {
        return false;
    }

    bool ClassTable::buildInheritanceGraph() {
        return false;
    }

    bool ClassTable::isGraphAcyclic() {
        return false;
    }

    bool ClassTable::isValid() {
        return false;
    }

    bool ClassTable::isSubtype(const std::string &type1, const std::string &type2) {
        return false;
    }

    bool ClassTable::isTypeDefined(const std::string &type) {
        return false;
    }

    bool ClassTable::isPrimitive(const std::string &type) {
        return false;
    }
} // CoolCompiler